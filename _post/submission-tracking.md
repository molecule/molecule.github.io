...
submissions:
    -
        ...
        secretTitle: Avatar
        notes: I'm one of many co-authors on this project lead by a fellow intern at Microsoft. Finally accepted!
    ...
    -
        ...
        secretTitle: Beyond Audio - Towards a Design Space for Headphones as a Site for Interaction and Sensing
    ...
    -
        ...
        conference: CHI'22
        subTitle: Secret Headphones Paper (Title redacted until work is published)
        secretTitle: Semantic Peripherals - Deriving Semantic Meaning from the Digital, Physical and Socio-Cultural Contexts
    ...
    -
        ...
        notes: This paper has evolved - lots of co-authors with different home research methodologies, and finding the version of the paper that satisfies everyone has been an interesting challenge! Also did you know that GROUP is not double-blind??
        icon: /src/img/icon-noun_X_1890803.png
    ...
    -
        ...
        finalResult: UIST'21 | <a href="/src/papers/2021-uist-air-constellations.pdf">PDF</a>
    -
        submissionNum: 23
        conference: CSCW'22
    ...
    -
        ...
        finalResult: TEI'19 | <a href="/src/papers/conversation-w-actuators.pdf">PDF</a>
    -
        submissionNum: 5
        conference: DIS'18
        ...
        icon: /src/img/icon-noun_checkmark_364806.png
        journey: Accepted on first submission.
        finalResult: DIS'18 | <a href="/src/papers/Guardians_of_Practice_dis2019.pdf">PDF</a>
    -
        submissionNum: 4
        conference: CHI'18
        ...
        icon: /src/img/icon-noun_checkmark_364806.png
        journey: Accepted on first submission.
        finalResult: CHI'18 | <a href="/src/papers/AlterWear_chi2018.pdf">PDF</a>
    - 
        submissionNum: 3
        conference: TEI'18
        ...
        icon: /src/img/icon-noun_checkmark_364806.png
        journey: Accepted on first submission.
        finalResult: TEI'18 | <a href="/src/papers/HairIO-tei2018.pdf">PDF</a>
    -
        submissionNum: 2
        conference: UIST'17
        ...
        finalResult: TEI '19 (see Submission 6)
    -
        submissionNum: 1
        conference: CHI'17
        ...
        finalResult: CHI '17 Best Paper Award | <a href="/src/papers/IlluminationAesthetics-chi2017.pdf">PDF</a>
        icon:  /src/img/icon-noun_779891.svg
...
{% for submish in page.submissions %}
  ...
  <tr>
    <td></td>
    <td></td>
    <td colspan="2">Journey: {{submish.journey}}</td>
  <tr>
    <td></td>
    <td></td>
